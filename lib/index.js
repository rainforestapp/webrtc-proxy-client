...
export default function init(videoUrl, videoElemId) {
  let webrtcServer = new WebRtcStreamer(videoElemId, '');
  window.onload = function() {
    webrtcServer.connect(videoUrl, '', undefined);
    setupElement(document.getElementById(videoElemId), webrtcServer);
  };
